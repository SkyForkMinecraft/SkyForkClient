...
public class RiseShaderUtil implements Access.InstanceAccess {
    ...
    public static String getShaderResource(final String resource) {
        try {
            final InputStream inputStream = RESOURCE_MANAGER.getResource(new ResourceLocation("client/shaders/" + resource)).getInputStream();
