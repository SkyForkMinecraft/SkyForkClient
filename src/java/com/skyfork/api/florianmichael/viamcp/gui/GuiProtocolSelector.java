...
package com.skyfork.api.florianmichael.viamcp.gui;

import com.skyfork.api.florianmichael.viamcp.protocolinfo.ProtocolInfo;
...
public class GuiProtocolSelector extends GuiScreen {
    ...
    class SlotList extends GuiSlot {
        ...
        protected void drawSlot(int i, int i1, int i2, int i3, int i4, int i5) {
            drawCenteredString(super.mc.fontRendererObj, (ViaLoadingBase.PROTOCOLS.indexOf(ViaLoadingBase.getInstance().getTargetVersion()) == i ? EnumChatFormatting.GREEN.toString() + EnumChatFormatting.BOLD : EnumChatFormatting.GRAY.toString()) + ViaLoadingBase.getProtocols().get(i).getName(), super.width / 2, i2 + 2, -1);
            GlStateManager.pushMatrix();
            GlStateManager.scale(0.5, 0.5, 0.5);
            drawCenteredString(super.mc.fontRendererObj, "PVN: " + ViaLoadingBase.getProtocols().get(i).getVersion(), super.width, (i2 + 2) * 2 + 20, -1);
            GlStateManager.popMatrix();
        }
    }
}
