...
public class AsyncVersionSlider extends GuiButton {
    ...
    public AsyncVersionSlider(int buttonId, int x, int y, int widthIn, int heightIn) {
        ...
        List<ProtocolVersion> protocols = ViaLoadingBase.PROTOCOLS;
        Collections.sort(protocols);
        this.dragValue = (float) protocols.indexOf(ViaLoadingBase.getInstance().getTargetVersion()) / protocols.size();
