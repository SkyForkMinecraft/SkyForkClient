...
package com.skyfork.api.florianmichael.vialoadingbase;

import com.skyfork.api.florianmichael.vialoadingbase.model.Platform;
import com.skyfork.api.florianmichael.vialoadingbase.platform.ViaBackwardsPlatformImpl;
import com.skyfork.api.florianmichael.vialoadingbase.platform.ViaRewindPlatformImpl;
import com.skyfork.api.florianmichael.vialoadingbase.platform.ViaVersionPlatformImpl;
import com.skyfork.api.florianmichael.vialoadingbase.platform.viaversion.VLBViaCommandHandler;
import com.skyfork.api.florianmichael.vialoadingbase.platform.viaversion.VLBViaInjector;
import com.skyfork.api.florianmichael.vialoadingbase.platform.viaversion.VLBViaProviders;
import com.skyfork.api.florianmichael.vialoadingbase.util.JLoggerToLog4j;
...
public class ViaLoadingBase {
    ...
    public void initPlatform() {
        ...
        final ViaVersionPlatformImpl viaVersionPlatform = new ViaVersionPlatformImpl(LOGGER);
        ...
        manager.addEnableListener(() -> {
            for (Platform platform : this.platforms) platform.build(LOGGER);
        });
        ...
        LOGGER.info("ViaLoadingBase has loaded " + Platform.COUNT + "/" + platforms.size() + " platforms");
    }
