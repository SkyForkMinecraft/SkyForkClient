...
package com.skyfork.api.florianmichael.vialoadingbase.netty;

import com.viaversion.viaversion.api.connection.UserConnection;
import com.skyfork.api.florianmichael.vialoadingbase.netty.event.CompressionReorderEvent;
import com.skyfork.api.florianmichael.vialoadingbase.netty.handler.VLBViaDecodeHandler;
import com.skyfork.api.florianmichael.vialoadingbase.netty.handler.VLBViaEncodeHandler;
...
public abstract class VLBPipeline extends ChannelInboundHandlerAdapter {
    ...
    protected VLBPipeline(final UserConnection user) {
        this.user = user;
    }
