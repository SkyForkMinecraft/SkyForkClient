package com.skyfork.api.betterfps;
...
public class BetterFpsHelper {
    ...
    public static void loadConfig() {
        ...
        if(MCDIR == null) {
            CONFIG_FILE = new File("Skyfork/betterfps.json").getAbsoluteFile();
        } else {
            CONFIG_FILE = new File(MCDIR, "Skyfork/betterfps.json").getAbsoluteFile();
        }
