package com.skyfork.api.cedo.particles;

import com.skyfork.api.cedo.misc.MutablePair;
 ...
 * @since 05/23/2022
 */
public class ParticleEngine implements Access.InstanceAccess {
    ...
    public ParticleEngine(int width,int height) {
        particleImages.add(new ParticleImage(1, Pair.of(width, height)));
        particleImages.add(new ParticleImage(2, Pair.of(width, height)));
        particleImages.add(new ParticleImage(3, Pair.of(width, height)));
        particleImages.add(new ParticleImage(4, Pair.of(width, height)));
        particleImages.add(new ParticleImage(5, Pair.of(width, height)));
        particleImages.add(new ParticleImage(6, Pair.of(width, height)));
        particleImages.add(new ParticleImage(7, Pair.of(width, height)));
        particleImages.add(new ParticleImage(8, Pair.of(width, height)));
    }
