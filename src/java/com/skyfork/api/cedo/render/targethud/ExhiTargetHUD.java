...
public class ExhiTargetHUD extends TargetHUD {
    ...
    public void render(float x, float y, float alpha, EntityLivingBase target) {
        setWidth(Math.max(135, FontManager.M20.getStringWidth("Name: " + "bruh") + 60));
        setHeight(46);
        ...
        FontManager.M16.drawString(target.getName(), x + 8 + size, y + 6, textColor.getRGB());
        ...
        FontManager.M13.drawString("HP: " + MathUtils.round(target.getHealth() + target.getAbsorptionAmount(), 1) + " | Dist: " + MathUtils.round(mc.thePlayer.getDistanceToEntity(target), 1),
        ...
        for (int i = 0; i <= 3; i++) {
            ...
            GLUtil.startBlend();
            RenderUtil.color(textColor.getRGB());
            float v = x + size + 7 + (seperation * (3 - i));
            mc.getRenderItem().renderItemAndEffectIntoGUI(target.getCurrentArmor(i), (int) v, (int) (y + 28));
            RenderUtil.drawExhiEnchants(target.getCurrentArmor(i), (int) v, (int) (y + 30));
        ...
        if (target.getHeldItem() != null) {
            ...
            RenderUtil.drawExhiEnchants(target.getHeldItem(), (int) (x + size + 7 + (seperation * 4)), (int) (y + 30));
