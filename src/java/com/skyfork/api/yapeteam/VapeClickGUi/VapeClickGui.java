...
import com.skyfork.api.cedo.misc.TimerUtil;
...
import com.skyfork.api.yapeteam.util.Stencil;
...
public class VapeClickGui extends GuiScreen {
    ...
    public void initGui() {
        ...
        valuetimer.reset();
        modules.clear();
        for (ModuleHandle module : Access.getInstance().getModuleManager().getCModules().values()) {
                modules.add(module);
        }
    }
    ...
    private final ArrayList<ModuleHandle> modules = new ArrayList<>();
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        //绘制主窗口
        RoundedUtil.drawRound(windowX, windowY, windowX + width, windowY + height, 5, new Color(21, 22, 25).getRGB());
        if (selectMod == null) {
            FontManager.M20.drawString(Access.CLIENT_NAME.toUpperCase(Locale.ROOT), windowX + 20, windowY + height - 20, new Color(77, 78, 84).getRGB());
        }
        //绘制顶部图标
        ...
        for (Enum<?> e : ClickType.values()) {
            ...
            if (e != ClickType.Settings) {
                if (e == selectType) {
                    ...
                    FontManager.M18.drawString(e.name(), typeXAnim[i] + 20, windowY + 15, new Color(255, 255, 255).getRGB());
                    typeX += (32 + FontManager.M18.getStringWidth(e.name() + " "));
                } else {
        ...
        if (selectType == ClickType.Home) {
            Stencil.write(false);
            RenderUtil.drawRect(windowX, windowY, width, height, -1);
            Stencil.erase(true);
            if (selectMod != null) {
                if (valuemodx > -80) {
                    valuemodx -= 5;
            ...
            if (selectMod != null) {
                RoundedUtil.drawRound(windowX + 430 + valuemodx, windowY + 60, windowX + width, windowY + height - 20, 3, new Color(32, 31, 35).getRGB());
                RoundedUtil.drawRound(windowX + 430 + valuemodx, windowY + 60, windowX + width, windowY + 85, 3, new Color(39, 38, 42).getRGB());
                ...
                for (AbstractValue v : selectMod.getValues()) {
                    if (v instanceof BooleanValue) {
                        if (valuey + 4 > windowY + 100) {
                            if (((Boolean) v.getValue())) {
                                FontManager.M16.drawString(v.getName(), windowX + 445 + valuemodx, valuey + 4, -1);
                                v.optionAnim = 100;
                                RoundedUtil.drawRound(windowX + width - 30, valuey + 2, windowX + width - 10, valuey + 12, 4, new Color(33, 94, 181, (int) (v.optionAnimNow / 100 * 255)).getRGB());
                                RenderUtil.drawCircle(windowX + width - 25 + 10 * (v.optionAnimNow / 100f), valuey + 7, 3.5f, new Color(255, 255, 255).getRGB());
                            } else {
                                FontManager.M14.drawString(v.getName(), windowX + 445 + valuemodx, valuey + 4, new Color(73, 72, 76).getRGB());
                                v.optionAnim = 0;
                                RoundedUtil.drawRound(windowX + width - 30, valuey + 2, windowX + width - 10, valuey + 12, 4, new Color(59, 60, 65).getRGB());
                                RoundedUtil.drawRound(windowX + width - 29, valuey + 3, windowX + width - 11, valuey + 11, 3, new Color(32, 31, 35).getRGB());
                ...
                for (AbstractValue v : selectMod.getValues()) {
                    if (v instanceof NumberValue) {
                        if (valuey + 4 > windowY + 100) {
                            ...
                            FontManager.M16.drawString(v.getName(), windowX + 445 + valuemodx, valuey + 5, new Color(73, 72, 76).getRGB());
                            FontManager.M16.drawCenteredString(v.getValue().toString(), windowX + width - 20, valuey + 5, new Color(255, 255, 255).getRGB());
                ...
                for (AbstractValue v : selectMod.getValues()) {
                    if (v instanceof ComboValue) {
                        ComboValue modeValue = (ComboValue) v;

                        if (valuey + 4 > windowY + 100 & valuey < (windowY + height)) {
                            RoundedUtil.drawRound(windowX + 445 + valuemodx, valuey + 2, windowX + width - 5, valuey + 22, 2, new Color(46, 45, 48).getRGB());
                            RoundedUtil.drawRound(windowX + 446 + valuemodx, valuey + 3, windowX + width - 6, valuey + 21, 2, new Color(32, 31, 35).getRGB());
                            FontManager.M18.drawString(v.getName() + ":" + modeValue.getValue(), windowX + 455 + valuemodx, valuey + 10, new Color(230, 230, 230).getRGB());
                            FontManager.M18.drawString(">", windowX + width - 15, valuey + 9, new Color(73, 72, 76).getRGB());
                            if (isHovered(windowX + 445 + valuemodx, valuey + 2, windowX + width - 5, valuey + 22, mouseX, mouseY) && Mouse.isButtonDown(0) && valuetimer.hasTimeElapsed(300)) {
                                if (Arrays.binarySearch(modeValue.getStrings(), (v.getValue()))
                                        + 1 < modeValue.getStrings().length) {
                                    v.setValue(modeValue.getStrings()[Arrays.binarySearch(modeValue.getStrings(), (v.getValue())) + 1]);
                                } else {
                                    v.setValue(modeValue.getStrings()[0]);
                                }
                                valuetimer.reset();
                            }
                        }
            ...
            for (ModuleHandle module : modules) {
                if (isHovered(windowX + 100 + valuemodx, modY - 10, windowX + 425 + valuemodx, modY + 25, mouseX, mouseY) && Mouse.isButtonDown(0)) {
                    if (valuetimer.hasTimeElapsed(300) && modY + 40 > (windowY + 70) && modY < (windowY + height)) {
                ...
                if (isHovered(windowX + 100 + valuemodx, modY - 10, windowX + 425 + valuemodx, modY + 25, mouseX, mouseY)) {
                    if (module.isEnabled()) {
                        RoundedUtil.drawRound(windowX + 100 + valuemodx, modY - 10, windowX + 425 + valuemodx, modY + 25, 3, new Color(43, 41, 45).getRGB());
                    } else {
                        RoundedUtil.drawRound(windowX + 100 + valuemodx, modY - 10, windowX + 425 + valuemodx, modY + 25, 3, new Color(35, 35, 35).getRGB());
                    }
                } else {
                    if (module.isEnabled()) {
                        RoundedUtil.drawRound(windowX + 100 + valuemodx, modY - 10, windowX + 425 + valuemodx, modY + 25, 3, new Color(36, 34, 38).getRGB());
                    } else {
                        RoundedUtil.drawRound(windowX + 100 + valuemodx, modY - 10, windowX + 425 + valuemodx, modY + 25, 3, new Color(32, 31, 33).getRGB());
                    }
                }
                RoundedUtil.drawRound(windowX + 100 + valuemodx, modY - 10, windowX + 125 + valuemodx, modY + 25, 3, new Color(37, 35, 39).getRGB());
                RoundedUtil.drawRound(windowX + 410 + valuemodx, modY - 10, windowX + 425 + valuemodx, modY + 25, 3, new Color(39, 38, 42).getRGB());
                FontManager.M20.drawString(".", windowX + 416 + valuemodx, modY - 5, new Color(66, 64, 70).getRGB());
                FontManager.M20.drawString(".", windowX + 416 + valuemodx, modY - 1, new Color(66, 64, 70).getRGB());
                FontManager.M20.drawString(".", windowX + 416 + valuemodx, modY + 3, new Color(66, 64, 70).getRGB());

                if (module.isEnabled()) {
                    FontManager.M18.drawString(module.getName(), windowX + 140 + valuemodx, modY + 5, new Color(220, 220, 220).getRGB());
                    RoundedUtil.drawRound(windowX + 100 + valuemodx, modY - 10, windowX + 125 + valuemodx, modY + 25, 3, new Color(41, 117, 221, (int) (module.optionAnimNow / 100f * 255)).getRGB());
                    ...
                    RoundedUtil.drawRound(windowX + 380 + valuemodx, modY + 2, windowX + 400 + valuemodx, modY + 12, 4, new Color(33, 94, 181, (int) (module.optionAnimNow / 100f * 255)).getRGB());
                    RenderUtil.drawCircle(windowX + 385 + 10 * module.optionAnimNow / 100 + valuemodx, modY + 7, 3.5f, new Color(255, 255, 255).getRGB());
                } else {
                    FontManager.M18.drawString(module.getName(), windowX + 140 + valuemodx, modY + 5, new Color(108, 109, 113).getRGB());
                    ...
                    RoundedUtil.drawRound(windowX + 380 + valuemodx, modY + 2, windowX + 400 + valuemodx, modY + 12, 4, new Color(59, 60, 65).getRGB());
                    RoundedUtil.drawRound(windowX + 381 + valuemodx, modY + 3, windowX + 399 + valuemodx, modY + 11, 3, new Color(29, 27, 31).getRGB());
                    RenderUtil.drawCircle(windowX + 385 + 10 * module.optionAnimNow / 100 + valuemodx, modY + 7, 3.5f, new Color(59, 60, 65).getRGB());
                }
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        ...
        for (ClickType e : ClickType.values()) {
            if (e != ClickType.Settings) {
                if (e == selectType) {
                    if (isHovered(typeX, windowY + 10, typeX + 16 + FontManager.M18.getStringWidth(e.name() + " "), windowY + 10 + 16, mouseX, mouseY)) {
                        selectType = e;
                    }
                    typeX += (32 + FontManager.M18.getStringWidth(e.name() + " "));
                } else {
