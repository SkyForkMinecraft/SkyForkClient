...
public class NormalClickGUI
    ...
    public static ModuleHandle currentModule;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
       ...
       // RenderUtil.drawShadow(this.startX - 40.0f, this.startY, this.startX + 420.0f, this.startY + 320.0f);
        FontManager.M18.drawString("Xylitol Client", this.startX - 18.0f, (float)((double)(this.startY + 4.0f) + FontManager.M18.getHeight()), this.getColor(100, 100, 100, 255));
        Category[] mY = Category.values();
        for (int m = 0; m < Category.values().length; ++m) {
            if (mY[m] != currentModuleType) {
                FontManager.M18.drawString(mY[m].toString(), (int)this.startX + 2, (int)this.startY + 37 + m * 42, this.getColor(80, 80, 80, 255));
            } else {
                categoryAnim = this.animationUtil.animateNoFast(categoryAnim, m * 42, 12.0);
                FontManager.M22.drawString(mY[m].toString(), (int)this.startX + 2, (int)this.startY + 36 + m * 42, this.getColor(80, 80, 80, 255));
                RenderUtil.drawRect((int)this.startX - 28, (double)((int)this.startY + 32) + categoryAnim, (int)this.startX - 26, (double)((int)this.startY + 48) + categoryAnim, Access.CLIENT_COLOR.getRGB());
            }
            ...
            currentModule = !Access.getInstance().getModuleManager().getModulesByCategory(currentModuleType).isEmpty() ? Access.getInstance().getModuleManager().getCModulesByCategory(currentModuleType).get(0) : null;
            moduleStart = 0;
            moduleAnim = 0.0;
        }
        double moduleSize = Access.getInstance().getModuleManager().getCModulesByCategory(currentModuleType).size() - 1;
        ...
        if (Access.getInstance().getModuleManager().getCModulesByCategory(currentModuleType).size() > 1) {
        ...
        FontManager.M16.drawString(currentModuleType.toString(), this.startX + 70.0f, this.startY + 12.5f, this.getColor(80, 80, 80, 255));
        if (currentModule != null) {
            int i;
            float CStartY = 29.0f;
            FontManager.M20.drawString(NormalClickGUI.currentModule.getName(), this.startX + 210.0f, this.startY + 12.5f, this.getColor(60, 60, 60, 255));
            RenderUtil.startGlScissor((int)(this.startX + 60.0f), (int)(this.startY + 22.5f), (int)(this.startX + 200.0f), 290);
            for (i = 0; i < Access.getInstance().getModuleManager().getCModulesByCategory(currentModuleType).size(); ++i) {
                ModuleHandle value = Access.getInstance().getModuleManager().getCModulesByCategory(currentModuleType).get(i);
                RoundedUtil.drawRound(this.startX + 195.0f, CStartY + this.startY + moreAddY, this.startX + 65.0f, CStartY + 20.0f + this.startY + moreAddY, this.getColor(60, 60, 60, 255));
                if (!value.isEnabled()) {
                ...
                if (this.isSettingsButtonHovered(this.startX + 67.0f, CStartY + 2.0f + this.startY + moreAddY, this.startX + 183.0f, CStartY + 16.0f + (float)FontManager.M20.getHeight() + this.startY + moreAddY, mouseX, mouseY)) {
                    if (!this.previousmouse && Mouse.isButtonDown(0)) {
                        value.setEnable(!value.isEnabled());
                        this.previousmouse = true;
                    }
                    if (!this.previousmouse && Mouse.isButtonDown(1)) {
                        this.previousmouse = true;
                    }
                    FontManager.M16.drawString(value.getName(), this.startX + 86.0f, CStartY + 8.0f + this.startY + moreAddY, this.getColor(120, 120, 120, 255));
                } else {
                    FontManager.M16.drawString(value.getName(), this.startX + 86.0f, CStartY + 8.0f + this.startY + moreAddY, this.getColor(248, 248, 248, 255));
                }
                if (!Mouse.isButtonDown(0)) {
                    this.previousmouse = false;
                }
                if (this.isSettingsButtonHovered(this.startX + 90.0f, CStartY + this.startY + moreAddY, this.startX + 100.0f + (float)FontManager.M20.getStringWidth(value.getName()), CStartY + 8.0f + (float)FontManager.M20.getHeight() + this.startY + moreAddY, mouseX, mouseY) && Mouse.isButtonDown(1)) {
                    currentModule = value;
                    valueStart = 0;
                }
                FontManager.M20.drawString(":", this.startX + 185.0f, CStartY + 10.0f - (float)FontManager.M20.getHeight() / 2.0f + this.startY + moreAddY, this.getColor(255, 255, 255, 255));
            ...
            if (currentModule.getValues().isEmpty()) {
                FontManager.M18.drawCenteredString("No settings", this.startX + 310.0f, this.startY + 150.0f, this.getColor(60, 60, 60, 255));
            }
            ...
            for (i = 0; i < currentModule.getValues().size() && CStartY <= this.startY + 300.0f; ++i) {
                float x;
                AbstractValue<?> cValue;
                if (i < valueStart || !(cValue = currentModule.getValues().get(i)).isHidden()) continue;
                if (cValue instanceof NumberValue) {
                    x = this.startX + 295.0f;
                    double current = 62.0f * (((Number)((NumberValue)cValue).getValue()).floatValue() - ((NumberValue)cValue).getMinimum().floatValue()) / (((NumberValue)cValue).getMaximum().floatValue() - ((NumberValue)cValue).getMinimum().floatValue());
                    RenderUtil.drawRect(x - 4.0f, CStartY + 1.0f, (float)((double)x + 69.0), CStartY + 4.0f, this.getColor(50, 50, 50, 255));
                    RoundedUtil.drawRound(x + 75.0f, CStartY - 3.0f, (float)((double)x + 100.0), CStartY + 9.0f, 1.0f,this.getColor(55, 55, 55, 255));
                    ...
                    FontManager.M18.drawString(cValue.getName(), this.startX + 210.0f, CStartY, this.getColor(100, 100, 100, 255));
                    if (!Mouse.isButtonDown(0)) {
                        this.previousmouse = false;
                    }
                    if (((Number)cValue.getValue()).doubleValue() - (double)((Number)cValue.getValue()).intValue() == 0.0) {
                        FontManager.M18.drawCenteredStringWithShadow(String.valueOf(((Number)cValue.getValue()).intValue()), x + 67.0f + 20.0f, CStartY, this.getColor(255, 255, 255, 255));
                    } else {
                        FontManager.M18.drawCenteredStringWithShadow(String.valueOf((Number)cValue.getValue()), x + 67.0f + 20.0f, CStartY, this.getColor(255, 255, 255, 255));
                    }
                    if (this.isButtonHovered(x, CStartY - 2.0f, x + 100.0f, CStartY + 7.0f, mouseX, mouseY) && Mouse.isButtonDown(0)) {
                        if (!this.previousmouse && Mouse.isButtonDown(0)) {
                            current = ((NumberValue)cValue).getMinimum();
                            double max = ((NumberValue)cValue).getMaximum();
                            double inc = ((NumberValue)cValue).getIncrement();
                ...
                if (cValue instanceof BooleanValue) {
                    x = this.startX + 317.0f;
                    FontManager.M18.drawString(cValue.getName(), this.startX + 210.0f, CStartY, this.getColor(100, 100, 100, 255));
                    RoundedUtil.drawRound(x + 56.0f, CStartY, x + 76.0f, CStartY + 8.0f, 3, this.getColor(60, 60, 60, 255));
                    if (((Boolean)cValue.getValue()).booleanValue()) {
                        RenderUtil.drawCircle(x + 70.5F, CStartY + 4.0f, 4.0F, this.getColor(61, 141, 255, 255));
                    } else {
                        RenderUtil.drawCircle(x + 62.0f, CStartY + 4.0f, 4.0F, this.getColor(120, 120, 120, 255));
                    }
                    if (this.isCheckBoxHovered(x + 56.0f, CStartY, x + 76.0f, CStartY + 9.0f, mouseX, mouseY)) {
                        ...
                        if (this.mouse) {
                        //    cValue.setValue(cValue.getValue() == false);
                            this.mouse = false;
                        }
                    }
                    if (!Mouse.isButtonDown(0)) {
                ...
                /*
                if (cValue instanceof ComboValue) {
                    x = this.startX + 300.0f;
                    ComboValue mode = ((ComboValue)cValue);
                    String next_str = ((ComboValue) cValue).getNextValue();
                    int next_str_2 = ((ComboValue) cValue).getAsArray().size() + 1 >= mode.getAsArray().size() ? 0 : mode.getAsArray().size() + 1;
                    FontManager.M18.drawString(cValue.getName(), this.startX + 210.0f, CStartY + 2.0f, this.getColor(100, 100, 100, 255));
                    RenderUtil.drawRect(x - 10.0f, CStartY - 5.0f, x + 95.0f, CStartY + 15.0f, this.getColor(56, 56, 56, 255));
                    RoundedUtil.drawBorderRect(x - 10.0f, CStartY - 5.0f, x + 95.0f, CStartY + 15.0f, this.getColor(60, 60, 60, 255), 2.0);
                    for (int i1 = 0; i1 < 2; ++i1) {
                        FontManager.M18.drawStringWithShadow(((ComboValue)cValue).getModes()[next_str].name().substring(((ComboValue)cValue).getModes()[next_str].name().length() - 2 + i1, ((ComboValue)cValue).getModes()[next_str].name().length() + i1 - 1), x - 3.0f + (float)(i1 * FontManager.M18.getStringWidth(((ComboValue)cValue).getModes()[next_str].name().substring(((ComboValue)cValue).getModes()[next_str].name().length() - 3 + i1, ((ComboValue)cValue).getModes()[next_str].name().length() + i1 - 2))), CStartY + 2.0f, this.getColor(255, 255, 255, 80 / (3 - (i1 + 1))));
                        FontManager.M18.drawStringWithShadow(((ComboValue)cValue).getModes()[next_str_2].name().substring(i1, i1 + 1), x + 79.0f + (float)(i1 > 0 ? i1 * FontManager.M18.getStringWidth(((ComboValue)cValue).getModes()[next_str_2].name().substring(i1 - 1, i1)) : 0), CStartY + 2.0f, this.getColor(255, 255, 255, 80 / (i1 + 1)));
                    }
                    FontManager.M18.drawStringWithShadow(((Enum)cValue.getValue()).name(), x + 42.5f - (float)(FontManager.M18.getStringWidth(((Enum)((ComboValue)cValue).getValue()).name()) / 2), CStartY + 2.0f, this.getColor(255, 255, 255, 255));
                    if (this.isStringHovered(x, CStartY - 5.0f, x + 100.0f, CStartY + 15.0f, mouseX, mouseY)) {
                        int next;
                        if (!this.previousmouse && Mouse.isButtonDown(0)) {
                            next = mode.getAsArray().size() + 1 >= ((ComboValue)cValue).getAsArray().size() ? 0 : mode.getAsArray().size() + 1;
                           // cValue.setValue(((ComboValue)cValue).getModes()[next]);
                            this.previousmouse = true;
                        }
                        if (Mouse.isButtonDown(1) && !this.Rpreviousmouse) {
                            next = mode.getAsArray().size() - 1 < 0 ? ((ComboValue)cValue).getAsArray().toArray().length - 1 : mode.getAsArray().size() - 1;
                            cValue.setValue(((ComboValue)cValue).getModes()[next]);
    ...
    static {
        ...
        categoryAnim = 0.0;
        valueAnim = 0.0;
        currentModuleType = Category.Client;
        currentModule = Access.getInstance().getModuleManager().getCModulesByCategory(currentModuleType).size() != 0 ? Access.getInstance().getModuleManager().getCModulesByCategory(currentModuleType).get(0) : null;
