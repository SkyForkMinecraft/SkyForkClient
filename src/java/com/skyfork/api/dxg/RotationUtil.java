...
import com.skyfork.api.alan.RotationComponent;
...
public class RotationUtil implements Access.InstanceAccess
{
    ...
    public static float getGCD() {
        return (float)(Math.pow(mc.gameSettings.mouseSensitivity * 0.6 + 0.2, 3.0) * 1.2);
    }
    ...
    public static float[] getHVHRotation(final Entity entity, final double maxRange) {
        ...
        final Vec3 BestPos = getNearestPointBB(mc.thePlayer.getPositionEyes(1.0f), entity.getEntityBoundingBox());
        final Location myEyePos = new Location(Minecraft.getMinecraft().thePlayer.posX, Minecraft.getMinecraft().thePlayer.posY + mc.thePlayer.getEyeHeight(), Minecraft.getMinecraft().thePlayer.posZ);
    ...
    public static Vector2f calculate(final Vec3 to) {
        return calculate(mc.thePlayer.getCustomPositionVector().add(0.0, mc.thePlayer.getEyeHeight(), 0.0), new Vector3d(to.xCoord, to.yCoord, to.zCoord));
    }
    
    public static Vector2f calculate(final Vector3d to) {
        return calculate(mc.thePlayer.getCustomPositionVector().add(0.0, mc.thePlayer.getEyeHeight(), 0.0), to);
    }
    ...
    public static Vector2f calculate(final Entity entity) {
        return calculate(entity.getCustomPositionVector().add(0.0, Math.max(0.0, Math.min(mc.thePlayer.posY - entity.posY + mc.thePlayer.getEyeHeight(), (entity.getEntityBoundingBox().maxY - entity.getEntityBoundingBox().minY) * 0.9)), 0.0));
    }
    ...
    public static Vector2f applySensitivityPatch(final Vector2f rotation, final Vector2f previousRotation) {
        final float mouseSensitivity = (float)(mc.gameSettings.mouseSensitivity * (1.0 + Math.random() / 1.0E7) * 0.6000000238418579 + 0.20000000298023224);
    ...
    public static float[] getRotationBlock(final BlockPos pos) {
        return getRotationsByVec(mc.thePlayer.getPositionVector().addVector(0.0, (double)mc.thePlayer.getEyeHeight(), 0.0), new Vec3(pos.getX() + 0.5, pos.getY() + 0.5, pos.getZ() + 0.5));
    }
