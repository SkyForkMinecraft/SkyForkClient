    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            if (s.length() > 0)
            {
                ...
                FontManager.M20.drawString(s1, (float)l, (float)i1, color);
            }
            ...
            {
                FontManager.M20.drawString(s.substring(j), (float)j1, (float)i1, color);
            }
            ...
            if (flag1)
            {
                ...
                {
                    FontManager.M20.drawString("_", (float)k1, (float)i1, color);
                }
            }
