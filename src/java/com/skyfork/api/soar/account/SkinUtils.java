...
public class SkinUtils {
    ...
    public static void loadSkin(Minecraft mc, String name, UUID uuid) {
        loadSkin(mc, name, uuid, new File(new File(mc.mcDataDir, "com/skyfork/api/soar/cachedImages/models"), name + ".png"), new File(new File(mc.mcDataDir, "com/skyfork/api/soar/cachedImages/faces"), name + ".png"));
    }
