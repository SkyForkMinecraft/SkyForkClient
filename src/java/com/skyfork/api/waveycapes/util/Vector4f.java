...
public class Vector4f {
    ...
    public Vector4f(float f, float g2, float h, float i) {
        this.x = f;
        this.y = g2;
        this.z = h;
        this.w = i;
    ...
    public void add(float f, float g2, float h, float i) {
        this.x += f;
        this.y += g2;
        this.z += h;
        this.w += i;
    ...
    public void transform(Matrix4f matrix4f) {
        ...
        float h = this.z;
        float i = this.w;
        this.x = matrix4f.m00 * f + matrix4f.m01 * g2 + matrix4f.m02 * h + matrix4f.m03 * i;
        this.y = matrix4f.m10 * f + matrix4f.m11 * g2 + matrix4f.m12 * h + matrix4f.m13 * i;
        this.z = matrix4f.m20 * f + matrix4f.m21 * g2 + matrix4f.m22 * h + matrix4f.m23 * i;
        this.w = matrix4f.m30 * f + matrix4f.m31 * g2 + matrix4f.m32 * h + matrix4f.m33 * i;
    }
    ...
    public void lerp(Vector4f vector4f, float f) {
        float g2 = 1.0f - f;
        this.x = this.x * g2 + vector4f.x * f;
        this.y = this.y * g2 + vector4f.y * f;
        this.z = this.z * g2 + vector4f.z * f;
        this.w = this.w * g2 + vector4f.w * f;
    }
