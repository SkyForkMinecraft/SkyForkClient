package cn.yapeteam.cloudmusic.api;

import cn.yapeteam.cloudmusic.MusicManager;
import cn.yapeteam.cloudmusic.impl.Lyric;
import cn.yapeteam.cloudmusic.impl.Track;
import cn.yapeteam.cloudmusic.util.ColUtils;
...
public enum CloudMusicAPI {
    ...
    public static String requestHttp(String url, Map<String, String> requestParams) throws Exception {
        String result;
        ...
        try {
            ...
            try {
                ...
                System.err.println("## release resouce error ##" + e);
            }
        }
        return result;
    }
    ...
    public String getSongJson(long id) throws Exception {
        ...
        return requestHttp("https://music.163.com/api/song/detail", ColUtils.mapOf(
    ...
    public ArrayList<Object[]> requestSong(String result) {//name,id,picUrl
        ...
        JsonArray r = obj.getAsJsonArray("songs");
        for (int i = 0; i < r.getAsJsonArray().size(); ++i) {
            JsonObject ar = (JsonObject) r.get(i).getAsJsonObject().get("artists").getAsJsonArray().get(0);
            JsonObject al = r.get(i).getAsJsonObject().get("album").getAsJsonObject();
            temp.add(new Object[]{
    ...
    public String getSearchJson(String text) throws Exception {
        return requestHttp("https://music.163.com/api/cloudsearch/get/web", ColUtils.mapOf(
                "type", String.valueOf(1),
                "total", String.valueOf(true),
                "limit", String.valueOf(100),
                "s", text
        ));
    }
    ...
    public Object[] getDownloadUrl(String songId, long bitRate) throws Exception {
        ...
        String json = (String) this.httpRequest("https://music.163.com/weapi/song/enhance/player/url", encryptRequest(obj.toString()), RequestType.POST)[0];
