...
public class MovementUtils implements Access.InstanceAccess {
    ...
    public static void setSpeed(MotionUpdateEvent moveEvent, double moveSpeed, float yaw, double strafe, double forward) {
        if (forward != 0.0D) {
            if (strafe > 0.0D) {
                yaw += ((forward > 0.0D) ? -45 : 45);
            } else if (strafe < 0.0D) {
    ...
    public static void setSpeed(MotionUpdateEvent moveEvent, double moveSpeed) {
