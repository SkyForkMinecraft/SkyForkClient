 ...
 */
public class ESP implements Access.InstanceAccess {
    ...
    public void onRender3D(Render3DEvent event) {
        for (Entity entity : mc.theWorld.loadedEntityList) {
            if (entity instanceof EntityPlayer && entity != mc.thePlayer && mc.thePlayer.canEntityBeSeen(entity)) {
                ...
                float green1 = ((EntityPlayer) entity).hurtTime > 0 ? 0.2F : 0.60F;
                float blue1 = 1.0F;
                float lineRed1 = ((EntityPlayer) entity).hurtTime > 0 ? 1.0F : 0.0F;
                float lineGreen1 = ((EntityPlayer) entity).hurtTime > 0 ? 0.2F : 0.60F;
                ...
                drawEntityESP(x1, y1, z1, width1, height1, red1, green1, blue1, 0.0F, lineRed1, lineGreen1, lineBlue1, 0.8F, 1.2F);
            }
        }
    }
